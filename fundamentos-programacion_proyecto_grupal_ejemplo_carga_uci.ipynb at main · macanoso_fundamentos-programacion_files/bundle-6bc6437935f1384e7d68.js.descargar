...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("6bc6437935f1384e7d68")
/******/ 	})();
/******/ 	
...
function isBrowserExtension() {
  ...
  return filename.includes('chrome-extension://') || stack.includes('chrome-extension://') || filename.includes('moz-extension://') || stack.includes('moz-extension://') || filename.includes('safari-extension://') || stack.includes('safari-extension://') || filename.includes('webkit-masked-url://') || stack.includes('webkit-masked-url://') || filename.includes('extension://') || stack.includes('extension://');
}
...
function reportError(event) {
  ...
  var errorType = name;
  if (RESIZE_OBSERVER_ERRORS.includes(message) || isBrowserExtension(filename, stack) || isDevConsoleError(stack) || isScriptError(message)) {
...
;// ./app/static/js/cell-accessibility.ts
...
;// ./app/static/js/html-sanitizer.ts
...
;// ./app/static/js/height-tracker.ts
...
;// ./node_modules/diary/diary/browser/index.mjs
...
;// ./app/static/js/origin-parser.ts
...
;// ./app/static/js/iframe-messenger.ts
...
/******/ })()
;
//# sourceMappingURL=bundle-6bc6437935f1384e7d68.js.map